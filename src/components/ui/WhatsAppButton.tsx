...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-20 right-4 lg:bottom-6 lg:right-6 z-50 flex items-center gap-2 bg-[#25D366] hover:bg-[#20b558] text-white rounded-full shadow-lg transition-all duration-200 hover:scale-105 active:scale-95"
